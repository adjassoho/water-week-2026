...
const infoCards = [
  {
    ...
    text: "Participants are responsible for verifying if they need a visa to enter Benin. Please consult official sources (embassies, consulates, or government portals) well in advance of your trip.",
  },
  {
    icon: (
      <svg className="w-8 h-8 text-[#058332]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'Getting to Cotonou',
    text: "Cotonou-Cadjehoun International Airport (COO) is located about 5 km from the city center, offering connections to major African and European cities.",
  },
  {
    icon: (
      <svg className="w-8 h-8 text-[#058332]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'Accommodation',
    text: "Cotonou offers a wide range of accommodations: luxury hotels, guest houses, and apartments. Book according to your preferences and budget via trusted platforms. The organizing committee may share negotiated hotel rates at a later date.",
  },
  {
    icon: (
      <svg className="w-8 h-8 text-[#058332]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    text: "The Palais des Congrès of Cotonou is located in the heart of the city, on the Boulevard de the Marina. It is accessible by taxi, motorcycle taxi (zémidjan), or on foot depending on the location of your accommodation.",
  },
];
    ...
    <div className="min-h-screen font-sans bg-white">
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Conference <span className="font-accent italic font-medium">Venue</span>
          </h1>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 items-start">
            ...
            <div className="md:col-span-3 bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {infoCards.map((card, i) => (
                  <div key={i} className="space-y-2">
                    {card.icon}
                    <h3 className="font-bold text-[#02345e] text-base" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                      {card.title}
                    </h3>
              ...
              <p className="mt-8 text-center text-gray-400 text-xs italic border-t border-gray-100 pt-4">
                Participants are kindly requested to organize their own visa, transport, accommodation, and local travel. (The organizing committee may share negotiated hotel rates at a later date.)
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl py-10">
          <div className="rounded-2xl overflow-hidden shadow-sm relative h-72 md:h-96">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              <h2 className="text-white font-extrabold text-2xl" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                Palais des Congrès de Cotonou
              </h2>
              <p className="text-white/70 text-sm">Boulevard de la Marina, Cotonou, Benin</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">Boulevard de la Marina, Cotonou, Benin</p>
                </div>
              </div>
              <a
